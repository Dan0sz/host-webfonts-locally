...
* Fixed: stylesheets generated by the WPTT Webfont Loader were removed from the page instead of being optimized because the compatibility fix's validation was inverted.
