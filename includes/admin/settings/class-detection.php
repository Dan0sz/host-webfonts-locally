...
<?php
	...
	private function fonts_processing_pro_options()
	{
		return [
			...
			'omgf_pro_process_imported_stylesheets' => [
				'label'		  => __('Process Imported Stylesheets', $this->plugin_text_domain),
				'description' => __('Scan local stylesheets for <code>@import</code> statements loading Google Fonts and process them.', $this->plugin_text_domain)
			],
