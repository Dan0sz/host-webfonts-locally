	...
	public function generate()
	{
		...
		foreach ($this->fonts as $font) {
			...
			foreach ($font->variants as $variant) {
				/**
				 * Allow plugins to add Fallback Font Stack.
				 * 
				 * @since v4.6.0
				 */
				$fallback_font_stack = apply_filters('omgf_pro_fallback_font_stack_' . $this->handle . '_' . $font->id, '');

				$font_family = $renamed_font_family ? ucfirst($renamed_font_family) : $variant->fontFamily;
				$font_family .= $fallback_font_stack ? ', ' . $fallback_font_stack : '';
