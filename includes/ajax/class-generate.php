...
class OMGF_AJAX_Generate extends OMGF_AJAX
{
	...
	private function init () {
		...
		try {
			...
			OMGF_Admin_Notice::set_notice(
				__( 'Congratulations! Your stylesheet was generated successfully and added to your theme\'s header.', 'host-webfonts-local' ),
				false
			);
		} catch ( Exception $e ) {
	...
	private function process_fonts ( $fonts ) {
		...
		foreach ( $fonts as $font ) {
			...
			if ( empty( $fontSources ) ) {
				OMGF_Admin_Notice::set_notice(
					__( '<strong>Download Fonts</strong> before generating the stylesheet.', 'host-webfonts-local' ),
					true,
					'error'
				);
			}
