        ...
        <div class="welcome-panel-column-container">
            <div class="welcome-panel-column" style="width: 32%;">
                ...
                <ul>
                    ...
                    <li class="welcome-icon dashicons-before dashicons-editor-removeformatting">To <i>remove externally hosted Google Fonts</i>, check the option or read <a target="_blank" href="<?= CAOS_WEBFONTS_SITE_URL; ?>/how-to/remove-google-fonts-wordpress">this</a>.</li>
