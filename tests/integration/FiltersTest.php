...
class FiltersTest extends TestCase {
	...
	public function testLegacyModeAgainstVariableFontsSupport() {
		...
		$class = new Optimize(
			'https://fonts.googleapis.com/css?family=Open+Sans:300,400,700&handle=traditional-fonts', 'traditional-fonts', 'variable-fonts'
		);
		$class->process();
		...
		$class = new Optimize(
			'https://fonts.googleapis.com/css?family=Open+Sans:300,400,700&handle=variable-fonts', 'variable-fonts', 'variable-fonts'
		);
		$class->process();
